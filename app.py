...
location_data['Death_Ratio'] = location_data.apply(
    lambda row: round((row['Victims_Killed'] / row['Total_Victims']) * 100, 2) 
        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody([
                    ...
                    dcc.Graph(id='monthly-trends-line-chart_2', style={'height': '330px', 'margin-top': '10px'})
                ])
            ], style={'box-shadow': '0 2px 8px rgba(0,0,0,0.1)', 'border': 'none'})
        ], width=4),
        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody([
                    ...
                    dcc.Graph(id='bar-chart_2', style={'height': '330px', 'margin-top': '10px'})
                ])
            ], style={'box-shadow': '0 2px 8px rgba(0,0,0,0.1)', 'border': 'none'})
        ], width=4)
...
def update_chart(selected_metric):
    ...
    fig = px.bar(
        ...
        category_orders={"Location": top_10_locations['Location'].tolist()}
    )
